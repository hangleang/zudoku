...
export interface SudokuVerifierInterface extends Interface {
...
export interface SudokuVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): SudokuVerifier;
  waitForDeployment(): Promise<this>;

  interface: SudokuVerifierInterface;
