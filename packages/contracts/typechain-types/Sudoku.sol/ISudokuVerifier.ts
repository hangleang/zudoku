...
export interface ISudokuVerifierInterface extends Interface {
...
export interface ISudokuVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): ISudokuVerifier;
  waitForDeployment(): Promise<this>;

  interface: ISudokuVerifierInterface;
