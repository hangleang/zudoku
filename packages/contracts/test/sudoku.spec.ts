...
describe("Sudoku", function () {
  ...
  before(async function () {
    ...
    sudoku = await ethers.deployContract("Sudoku", [sudokuVerifier.target]);
  ...
  it("Should return true for valid proof on-chain", async function () {
    ...
    let dataResult = await exportCallDataGroth16(input, "./zkproofs/sudoku.wasm", "./zkproofs/sudoku.zkey");
